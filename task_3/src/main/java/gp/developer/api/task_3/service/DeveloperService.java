...
import gp.developer.api.task_3.exception.*;
import gp.developer.api.task_3.repository.DeveloperRepository;
...
public class DeveloperService {
    ...
    public DeveloperEntity checkDeveloperInDBbyId(long id) throws DeveloperNotFoundException {
        ...
        return Optional.ofNullable(developerRepository.findById(id))
    ...
    public DeveloperEntity checkDeveloperInDBbyNameAndEmail(String name, String email) throws DeveloperNotFoundException {
        ...
        return Optional.ofNullable(developerRepository.findByNameAndEmail(name, email))
                .orElseThrow(DeveloperNotFoundException::new);
    }
